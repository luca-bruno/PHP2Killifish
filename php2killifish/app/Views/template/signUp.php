...
<body>
    <div class="centered">
        <div class="table" >
            <div>
                <h2 >Sign up</h2>
                <h3 class="underline" >For Free</h3>
            </div>
            ...
            <form >
                ...
                <input type="text" placeholder="Surname" name="suname" required>
                <br>
                ...
                <input type="text" placeholder="Confirm Email" name="email-repeat" required>
                <br>
                <label for="psw"></label>
